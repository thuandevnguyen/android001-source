...
import com.rxmobileteam.lecture9sample.databinding.FragmentBlank3Binding
...
class BlankFragment3 : Fragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    binding.tvNavigationFragment3.setOnClickListener {
      findNavController().popBackStack(destinationId = R.id.blankFragment, inclusive = false)
    }
  }
}